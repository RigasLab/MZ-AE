...
class Train_Methodology():
    ...
    def training_loop(self):
        ...
        for ix_epoch in range(self.load_epoch, self.load_epoch + self.nepochs):
            ...
            indentation = 10
            writeable_loss = {"epoch":ix_epoch.rjust(indentation),"Train_Loss":train_Ldict['avg_loss'].rjust(indentation), "Train_KoopEvo_Loss":train_Ldict['avg_KoopEvo_Loss'].rjust(indentation), "Train_Residual_Loss":train_Ldict['avg_Residual_Loss'].rjust(indentation), "Train_Autoencoder_Loss":train_Ldict["avg_Autoencoder_Loss"].rjust(indentation), "Train_StateEvo_Loss":train_Ldict["avg_StateEvo_Loss"].rjust(indentation), "Train_LatentEvo_Loss":train_Ldict["avg_LatentEvo_Loss"].rjust(indentation),\
                                                "Test_Loss":test_Ldict['avg_loss'].rjust(indentation), "Test_KoopEvo_Loss":test_Ldict['avg_KoopEvo_Loss'].rjust(indentation), "Test_Residual_Loss":test_Ldict['avg_Residual_Loss'].rjust(indentation),  "Test_Autoencoder_Loss":test_Ldict["avg_Autoencoder_Loss"].rjust(indentation), "Test_StateEvo_Loss":test_Ldict["avg_StateEvo_Loss"].rjust(indentation), "Test_LatentEvo_Loss":test_Ldict["avg_LatentEvo_Loss"].rjust(indentation),\
