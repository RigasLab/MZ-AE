...
class DynSystem_Data:
    ...
    def create_dataset(self, mode = "Both"):
        ...
        if mode == "Both" or mode == "Train":
            ...
            self.train_dataloader = DataLoader(self.train_dataset, batch_size=self.batch_size, shuffle = True, num_workers = 1)
        ...
        if mode == "Both" or mode == "Test":
            ...
            self.test_dataloader  = DataLoader(self.test_dataset, batch_size=self.batch_size, shuffle = False, num_workers = 1)
