...
class DynSystem_Data:
    ...
    def create_dataset(self, mode = "Both"):
        ...
        if mode == "Both" or mode == "Train":
            ...
            self.train_dataloader = DataLoader(self.train_dataset, batch_size=self.batch_size, shuffle = True)#, pin_memory = True, pin_memory_device='cuda:0', num_workers = 0)
        ...
        if mode == "Both" or mode == "Test":
            ...
            self.test_dataloader  = DataLoader(self.test_dataset, batch_size=self.batch_size, shuffle = False)#, pin_memory = True, pin_memory_device='cuda:0', num_workers = 0)
