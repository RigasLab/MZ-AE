...
python main.py --AE_Model Conv2D_Autoencoder --Seq_Model LSTM_Model --dynsys ExpData --bs 64 --lr 5e-5 --nepochs 8000 --nsave 1000 --train_size 0.8 --time_sample 10 --pred_horizon 5 --num_obs 12 --nhu 100 --seq_len 5 --info numobs --data_dir Data/ExpData/velocity.npy --exp_dir Trained_Models/Exp8.1.1_NumObs --deactivate_lrscheduler
